...
export declare class TestHelper {
     ...
     */
    static createMockRequestEvent(url: string, options?: {
        method?: string;
        user?: {
            id: number;
            name: string;
     ...
     */
    static createMockResponse<T>(data: T, status?: number, headers?: Record<string, string>): Response;
    /**
     ...
     */
    static assertResponse<T>(response: Response | undefined, status: number, expected: object): Promise<T | undefined>;
    /**
